...
<div>
    <div className="relative py-6 lg:py-8">
        <div className="z-10 relative container px-6 mx-auto flex flex-col md:flex-row items-start md:items-center justify-between">
            <div>
                <h4 className="text-2xl font-bold leading-tight text-gray-800">Order</h4>
            </div>
        </div>
    </div>
    ;
            ...
            <div className="py-12">
                <div className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                        ...
                        <i className="text-5xl	"><AiIcons.AiOutlineWallet/></i>
                        </div>
                        <h1 className="text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4">Enter Details</h1>
                        ...
                        <div className="relative mb-5 mt-2">
                            ...
                            <input id="cvc" className="mb-8 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="Nama Customer" />
                        </div>
                        ...
                        <div className="relative mb-5 mt-2">
                            ...
                            <input onClick={()=> setShowDate(!showDate)} id="expiry" className="text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder="MM/YY" />
                        </div>
                        {showDate && <DatePicker/>}
